...
// Retrieve high score from localStorage (if available)
...
function checkAns(idx) {
    if (userSeq[idx] === gameSeq[idx]) {
        ...
        let newHighScore = false; // Flag to check if new high score is set
        ...
        // Show high score only when the game ends
        h2.innerHTML = `Game Over! Your Score was <b>${level}</b> 
                        ${newHighScore ? `<br>🎉 <b>New High Score: ${highScore}!</b> 🎉` : `<br>High Score: <b>${highScore}</b>`}
